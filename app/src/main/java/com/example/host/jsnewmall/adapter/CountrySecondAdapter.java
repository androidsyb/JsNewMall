...
public class CountrySecondAdapter  extends BaseAdapter{
    ...
    private String[] arrTexta = new String[]{"国内游", "国内游", "国内游","文本标签"};
    private String[] arrTextb = new String[]{"国内游", "周边游", "国内游","国内游"};
    private String[] arrTextc = new String[]{"国内游", "周边游", "国内游","国内游"};
    ...
    public CountrySecondAdapter(Context context){
