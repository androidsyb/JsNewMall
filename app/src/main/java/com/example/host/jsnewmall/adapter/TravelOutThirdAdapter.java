...
public class TravelOutThirdAdapter extends BaseAdapter {
    ...
    private String[] arrTexta = new String[]{"出境游", "周边游", "出境游","文本标签","出境游", "文本标签", "周边游",};
    private String[] arrTextb = new String[]{"出境游", "出境游", "出境游","周边游","亲子游", "周边游", "周边游",};
    private String[] arrTextc = new String[]{"出境游", "出境游", "文本标签","文本标签","亲子游", "周边游", "周边游",};
    private String[] arrTextd = new String[]{"周边游", "周边游", "文本标签","周边游","亲子游", "文本标签", "周边游",};
    private String[] arrTexte = new String[]{"出境游", "出境游", "出境游","出境游","出境游", "周边游", "文本标签",};
    private String[] arrTextf = new String[]{"周边游", "出境游", "周边游","文本标签","出境游", "周边游", "周边游",};
    ...
    public TravelOutThirdAdapter(Context context){
